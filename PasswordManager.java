...
class SplashScreen {
    JFrame frame;
    JLabel text=new JLabel("Pssst Notes- Password and Notes");
    ...
    public void createGUI(){
        ...
        frame.getContentPane().setBackground(new Color(65,105,225)); // to set the background color of the frame
    ...
    public void addText()
    {
        text.setFont(new Font("Roboto",Font.BOLD,20)); // to set the font of the text
   ...
   public void addProgressBar() {
    progressBar.setBounds(100, 280, 200, 25); // Set the size of the progress bar
    progressBar.setBorderPainted(false);
    progressBar.setStringPainted(true);
    progressBar.setBackground(new Color(34, 34, 34)); 
    progressBar.setForeground(new Color(0, 184, 255));
    progressBar.setValue(0);

    UIManager.put("ProgressBar.selectionBackground", new Color(0, 184, 255)); 
    UIManager.put("ProgressBar.selectionForeground", new Color(0, 100, 145)); 
...
class PasswordManager implements ActionListener {
    ...
    public void GUIButtonsSetting(JButton btn){
        ...
        btn.setCursor(crs);
        Font fn = new Font("Roboto", Font.BOLD, 15);
        btn.setFont(fn);
    }
